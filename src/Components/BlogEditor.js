...
const BlogEditor = (props) => {
  ...
  const submit = () => {
    props.handleCallback(title, excerpt, content)
  }
      ...
      <div className="editor__modal">
        ...
        <div className="editor__modal--row-2">
          <div>
            ...
            <input id="subject" className="copy__para--medium" onChange={(e) => setTitle(e.target.value)} type="text"/>
          </div>
          <div>
            <p className="copy__para--medium">Excerpt</p>
            <input id="subject" className="copy__para--medium" onChange={(e) => setExcerpt(e.target.value)} type="text"/>
          </div>
        </div>
